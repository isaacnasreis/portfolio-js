...
export const metadata: Metadata = {
  title: "Isaac Reis | Principal Frontend Engineer & Product Designer",
  description: "Polo Tech de Isaac Reis. Construindo aplicações escaláveis da arquitetura ao pixel. Full Stack, UX Engineering e Product Design.",
  openGraph: {
    title: "Isaac Reis | Principal Frontend Engineer & Product Designer",
    description: "Polo Tech de Isaac Reis. Construindo aplicações escaláveis da arquitetura ao pixel.",
